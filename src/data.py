...
def get_data_loaders(
    batch_size: int = 32, valid_size: float = 0.2, num_workers: int = -1, limit: int = None
):
    """
...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    # Convert from CHW (the format used by pytorch) to HWC (the format expected by matplotlib)
